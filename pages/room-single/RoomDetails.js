                                    ...
                                    <div className="row">
                                        <div className="col-md-5 col-sm-5">
                                            <div className="room-d-text">
                                                ...
                                                <ul>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">Refrigerator and water</Link></li>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">Air Conditioner Facilities</Link></li>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">Fruits are always available</Link></li>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">2 Sets of nightwear</Link></li>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">Tables and Chairs</Link></li>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">2 Elevator Available</Link></li>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">Room Side Belcony</Link></li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-md-5 col-sm-5">
                                            <div className="room-d-text2">
                                                ...
                                                <ul>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">Daily Cleaning</Link></li>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">Special Swimming Pool</Link></li>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">Free Parking</Link></li>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">Free-to-use smartphone </Link></li>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">Free Wifi</Link></li>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">2 Elevator Available</Link></li>
                                                    <li><Link onClick={ClickHandler} href="/room-single/1">Room Side Belcony</Link></li>
                                                </ul>
                                            </div>
